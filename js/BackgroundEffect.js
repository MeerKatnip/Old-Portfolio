  ...
  if (!i.TweenLite) {
    ...
    var g = [0, 0, 1, 1],
      ...
      P = (y.register = function(t, e, i, s) {
        for (
          var n, r, a, o, l = e.split(','), _ = l.length, u = (i || 'easeIn,easeOut,easeInOut').split(',');
          --_ > -1;
      ...
      var i,
        ...
        d = function(t) {
          ...
          o > p && (u += o - c),
            ...
            (h.time = (x - u) / 1e3),
            (e = h.time - l),
            (!i || e > 0 || t === !0) && (h.frame++, (l += e + (e >= r ? 0.004 : r - e)), (a = !0)),
            t !== !0 && (n = s(d)),
        ...
        if (this._timeline) {
          if ((0 > t && !i && (t += this.totalDuration()), this._timeline.smoothChildTiming)) {
            ...
            if (
              (t > s && !i && (t = s),
              (this._startTime =
                (this._paused ? this._pauseTime : n._time) - (this._reversed ? s - t : t) / this._timeScale),
          ...
          this._gc && this._enabled(!0, !1),
            (this._totalTime !== t || 0 === this._duration) && (this.render(t, e, !1), O.length && M());
        }
        return this;
      }),
                  ...
                  ? 'string' != typeof r
                    ? r.length && r !== t && r[0] && (r[0] === t || (r[0].nodeType && r[0].style && !r.nodeType))
                      ...
                      : ((this._siblings[n] = $(r, this, !1)),
                        1 === l && this._siblings[n].length > 1 && K(r, this, null, 1, this._siblings[n]))
    ...
    var $ = function(t, e, i) {
        var s,
          ...
          r = t._gsTweenID;
        if (
          (F[r || (t._gsTweenID = r = 't' + j++)] || (F[r] = { target: t, tweens: [] }),
        ...
        for (r in this.vars) {
          if (((_ = this.vars[r]), G[r]))
            ...
            (this._firstPT = i[r] = h = {
              ...
              (h.s = h.f
                ? e[r.indexOf('set') || 'function' != typeof e['get' + r.substr(3)] ? r : 'get' + r.substr(3)]()
                : parseFloat(e[r])),
              (h.c =
        ...
        if (t >= l)
          (this._totalTime = this._time = l),
            ...
            0 === l &&
              ...
              (0 === t || 0 > h || h === _) && h !== t && ((i = !0), h > _ && (n = 'onReverseComplete')),
        ...
        if (this._time !== o || i) {
          if (!this._initted) {
            ...
            if (
              ...
              return (
                (this._time = this._totalTime = o), (this._rawPrevTime = h), O.push(this), (this._lazy = t), void 0
              );
            this._time && !s
          ...
          this._onUpdate &&
            ...
            e ||
              ((this._time !== o || s) &&
                this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || T))),
            n &&
              (!this._gc || i) &&
            ...
            for (n in l)
              (r = a[n]) &&
                ...
                (r.pg && 0 !== r.t._overwriteProps.length) ||
                  (r._prev ? (r._prev._next = r._next) : r === this._firstPT && (this._firstPT = r._next),
