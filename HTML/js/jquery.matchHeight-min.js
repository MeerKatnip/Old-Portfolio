...
(function(b) {
  var f = -1,
    ...
    m = function(a) {
      ...
      b(a).each(function() {
        var a = b(this),
          h = a.offset().top - g(a.css('margin-top')),
          k = 0 < c.length ? c[c.length - 1] : null;
        null === k ? c.push(a) : 1 >= Math.floor(Math.abs(d - h)) ? (c[c.length - 1] = k.add(a)) : c.push(a);
        d = h;
      });
      return c;
    },
      ...
      (d && 1 >= e.length) ||
        ...
        e.each(function() {
          ...
          'border-box' !== a.css('box-sizing') &&
            ((c += g(a.css('border-top-width')) + g(a.css('border-bottom-width'))),
            (c += g(a.css('padding-top')) + g(a.css('padding-bottom'))));
          a.css('height', f - c);
        }));
    });
    f.css('display', '');
    b.fn.matchHeight._maintainScroll && b(window).scrollTop((h / k) * b('html').outerHeight(!0));
    return this;
  };
  ...
  b.fn.matchHeight._update = function(a, d) {
    if (d && 'resize' === d.type) {
  ...
  b(window).bind('load', function(a) {
    b.fn.matchHeight._update();
  });
  b(window).bind('resize orientationchange', function(a) {
    b.fn.matchHeight._update(!0, a);
  });
})(jQuery);
