      ...
      function c(b, c) {
        ...
        ('top' !== this.options.tooltip_position && 'bottom' !== this.options.tooltip_position)
          ? 'horizontal' !== this.options.orientation ||
            ('left' !== this.options.tooltip_position && 'right' !== this.options.tooltip_position) ||
        ...
        if (this.sliderElem) p = !0;
          ...
          if (
            (s && this.options.labelledby[0] && m.setAttribute('aria-labelledby', this.options.labelledby[0]),
            s && this.options.labelledby[1] && n.setAttribute('aria-labelledby', this.options.labelledby[1]),
            !s &&
        ...
        if (C)
          for (
            this._addClass(this.handle1, this.options.handle), this._addClass(this.handle2, this.options.handle), g = 0;
            g < this.ticks.length;
            g++
          )
        ...
        e = {
          ...
          logarithmic: {
            toValue: function(a) {
              ...
              return (
                (d = this.options.min + Math.round((d - this.options.min) / this.options.step) * this.options.step),
        ...
        (b.prototype = {
            ...
            if (
              ...
              if (this.tickLabelContainer) {
                ...
                if (0 === this.options.ticks_positions.length)
                  'vertical' !== this.options.orientation && (this.tickLabelContainer.style[c] = -d / 2 + 'px'),
              ...
              for (var f = 0; f < this.options.ticks.length; f++) {
                ...
                this.options.reversed && (g = 100 - g),
                  ...
                  this.options.range
                    ...
                    : 'before' === this.options.selection && g <= a[0] && this._addClass(this.ticks[f], 'in-selection'),
                  this.tickLabels[f] &&
                    ((this.tickLabels[f].style[b] = d + 'px'),
                    'vertical' !== this.options.orientation && void 0 !== this.options.ticks_positions[f]
          ...
          _keydown: function(a, b) {
            ...
            if (c) {
              ...
              return (
                this.options.range && (f = [a ? this._state.value[0] : f, a ? f : this._state.value[1]]),
          ...
          _adjustPercentageForRangeSliders: function(a) {
            if (this.options.range) {
              ...
              0 === this._state.dragged && this._applyToFixedAndParseFloat(this._state.percentage[1], b) < c
              ...
              (this.options.range
                ? ((b = [this.options.min, this.options.max]),
                  0 !== this._state.percentage[0] &&
                    ((b[0] = this._toValue(this._state.percentage[0])), (b[0] = this._applyPrecision(b[0]))),
                  100 !== this._state.percentage[1] &&
                    ((b[1] = this._toValue(this._state.percentage[1])), (b[1] = this._applyPrecision(b[1]))))
